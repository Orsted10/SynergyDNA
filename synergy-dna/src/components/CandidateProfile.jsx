    ...
    <div className="panel">
      ...
      <div className="panel-body">
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <TraitBar label="AI & Machine Learning" value={candidate.skills.ai_ml} max={5} color="#0ea5e9" />
          <TraitBar label="Maths & Stats" value={candidate.skills.math_stats} max={5} color="#0ea5e9" />
          <TraitBar label="Coding Skills" value={candidate.skills.coding} max={5} color="#0ea5e9" />
          <TraitBar label="Big Data" value={candidate.skills.big_data} max={5} color="#0ea5e9" />
